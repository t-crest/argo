...
add wave -noupdate /noc_tb/p_spm_masters(0)(1).MCmd
...
add wave -noupdate /noc_tb/p_spm_masters(1)(1).MCmd
...
add wave -noupdate /noc_tb/noc2x2/nodes_m(0)/nodes_n(0)/node/na/slt_index
add wave -noupdate /noc_tb/noc2x2/nodes_m(0)/nodes_n(0)/node/na/vld_slt
...
add wave -noupdate /noc_tb/noc2x2/nodes_m(0)/nodes_n(0)/node/half_clk
...
add wave -noupdate /noc_tb/noc2x2/nodes_m(1)/nodes_n(1)/node/na/na_clk
...
add wave -noupdate -radix hexadecimal /noc_tb/noc2x2/nodes_m(1)/nodes_n(1)/node/na/phitIn
add wave -noupdate -radix hexadecimal /noc_tb/noc2x2/nodes_m(1)/nodes_n(1)/node/na/flit_buf
add wave -noupdate /noc_tb/noc2x2/nodes_m(1)/nodes_n(1)/node/na/spm_out.MCmd
add wave -noupdate -radix hexadecimal /noc_tb/noc2x2/nodes_m(1)/nodes_n(1)/node/na/spm_out.MAddr
add wave -noupdate -radix hexadecimal /noc_tb/noc2x2/nodes_m(1)/nodes_n(1)/node/na/spm_out.MData
add wave -noupdate -divider node_1_1
add wave -noupdate -radix binary /noc_tb/noc2x2/nodes_m(1)/nodes_n(1)/node/spm_out.MCmd
add wave -noupdate -radix hexadecimal /noc_tb/noc2x2/nodes_m(1)/nodes_n(1)/node/spm_out.MAddr
add wave -noupdate -radix hexadecimal /noc_tb/noc2x2/nodes_m(1)/nodes_n(1)/node/spm_in.SData
add wave -noupdate -divider node_0_1
add wave -noupdate /noc_tb/noc2x2/nodes_m(0)/nodes_n(1)/node/spm_out.MCmd
add wave -noupdate -radix hexadecimal /noc_tb/noc2x2/nodes_m(0)/nodes_n(1)/node/spm_out.MAddr
add wave -noupdate -radix hexadecimal /noc_tb/noc2x2/nodes_m(0)/nodes_n(1)/node/spm_in.SData
