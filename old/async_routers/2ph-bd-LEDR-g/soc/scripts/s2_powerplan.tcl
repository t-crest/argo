...
addStripe -block_ring_top_layer_limit M7 -max_same_layer_jog_length 6 -padcore_ring_bottom_layer_limit M5 -set_to_set_distance 50 -stacked_via_top_layer AP -padcore_ring_top_layer_limit M7 -spacing 2 -xleft_offset 40 -xright_offset 30 -merge_stripes_value 2.5 -layer M6 -block_ring_bottom_layer_limit M5 -width 3 -nets {GND VDD } -stacked_via_bottom_layer M1
redraw
fit