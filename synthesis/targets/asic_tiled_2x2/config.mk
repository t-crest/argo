asic_tiled_2x2: ../src/config_types.vhd \
 targets/asic_tiled_2x2/config.vhd \
 ...
 ../src/noc/tiled/tiled_noc.vhd clean
	dc_shell -f targets/asic_tiled_2x2/synthesis.tcl


asic_tiled_2x2_description:
	@echo "asic_tiled_2x2 "
	@echo "     synthesis for a tiled 2x2 noc with swapped ports"
	@echo "     and pipelined links with a single pipeline stage"

SYNTHESIS_DESCRIPTIONS += asic_tiled_2x2_description
